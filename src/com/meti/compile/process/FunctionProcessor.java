...
public class FunctionProcessor implements Processor {
	...
	public List<TypePair> createFields(Dependents dependents) {
		...
		TypePair pair = composePair(oldFields);
	...
	public TypePair composePair(List<TypePair> oldFields) {
		TypePair typePair = oldFields.get(0);
		String newName = typePair.apply(callStack::define);
		return typePair.applyToType(type -> new InlineTypePair(newName, type));
	}
}
